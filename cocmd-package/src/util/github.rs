...
mod tests {
    ...
    fn test_extract_github_url_parts() {
        assert_eq!(
            extract_github_url_parts("https://github.com/Moshe-Roth/cocmd").unwrap(),
            GitHubParts {
                author: "Moshe-Roth".to_string(),
                name: "cocmd".to_string(),
            }
        );

        assert_eq!(
            extract_github_url_parts("https://github.com/Moshe-Roth/cocmd.git").unwrap(),
            GitHubParts {
                author: "Moshe-Roth".to_string(),
                name: "cocmd".to_string(),
            }
        ...
        assert_eq!(
            extract_github_url_parts("git@github.com:Moshe-Roth/cocmd.git").unwrap(),
            GitHubParts {
                author: "Moshe-Roth".to_string(),
                name: "cocmd".to_string(),
            }
        ...
        assert!(
            extract_github_url_parts("https://gitlab.com/MosheRoth/cocmd-test-package/").is_none()
        );
    }
}
