...
# cocmdSelfParticipant

Being a subclass of [`cocmdParticipant`](./participant), all the properties and
methods of `cocmdParticipant` are available to `cocmdSelfParticipant`. Other than
