...
cocmd offers a host of customizations for the UI of meetings, some of which also
...
cocmd allows you to specify four color values.
...
The default behaviour of a meeting on cocmd is to take up the full viewport.
