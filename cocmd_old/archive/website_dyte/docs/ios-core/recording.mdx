...
To receive recording events, you must implement methods from `cocmdRecordingEventsListener`.
...
```swift
extension MeetingViewModel: cocmdRecordingEventsListener {
  ...
  func onMeetingRecordingStateUpdated(state: cocmdRecordingState) {
