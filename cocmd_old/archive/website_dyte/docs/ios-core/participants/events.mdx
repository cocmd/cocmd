...
```swift
    extension MeetingViewModel: cocmdParticipantEventsListener {
        func onParticipantJoin(participant: cocmdMeetingParticipant) {
...
```swift
    extension MeetingViewModel: cocmdParticipantEventsListener {
        func onParticipantLeave(participant: cocmdMeetingParticipant) {
...
```swift
    extension MeetingViewModel: cocmdParticipantEventsListener {
        func onVideoUpdate(videoEnabled: Bool, participant: cocmdMeetingParticipant) {
...
```swift
    extension MeetingViewModel: cocmdParticipantEventsListener {
        func onAudioUpdate(audioEnabled: Bool, participant: cocmdMeetingParticipant) {
...
```swift
    extension MeetingViewModel: cocmdParticipantEventsListener {
        func onActiveSpeakerChanged(participant: cocmdMeetingParticipant) {
...
```swift
    extension MeetingViewModel: cocmdParticipantEventsListener {
        func onParticipantPinned(participant: cocmdMeetingParticipant) {
            // your code here to show pinned participant
        }

        func onParticipantUnpinned(participant: cocmdMeetingParticipant) {
...
```swift
    extension MeetingViewModel: cocmdParticipantEventsListener {
        func onActiveParticipantsChanged(active: [cocmdMeetingParticipant]) {
