...
This information is intended for developers debugging or troubleshooting cocmd's web core system errors.
...
Here is a list of error code prefixes corresponding to each cocmd modules:
