...
const videoEnabled = usecocmdSelector((meeting) => meeting.self.videoEnabled);
const videoTrack = usecocmdSelector((meeting) => meeting.self.videoTrack);
...
const audioEnabled = usecocmdSelector((meeting) => meeting.self.audioEnabled);
const audioTrack = usecocmdSelector((meeting) => meeting.self.audioTrack);
...
```ts
const screenShareEnabled = usecocmdSelector((meeting) => meeting.self.screenShareEnabled);
const screenShareTrack = usecocmdSelector((meeting) => meeting.self.screenShareTrack);
```
