...
Before you start working with cocmd's Plugin SDK, make sure you've read the
[Getting Started](/getting-started) with cocmd guide.
...
Now that your plugin is created, It's time to start building. cocmd's `devTools`
