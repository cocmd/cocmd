...
cocmd Plugins allow you to have the most immersive, collaborative, and human
...
cocmd’s Plugin SDK allows you to create your own real-time applications that work
seamlessly with cocmd meetings. It comes with many interesting APIs and features
...
Let's see how you can use the Plugin SDK to create your own plugins for cocmd
meetings.
