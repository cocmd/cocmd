...
cocmd lets you publish multiple versions of your plugins. You can choose to
...
Each cocmd user is associated to a preset. This preset dictates the meeting
expirence for that user. You can customize how this preset can interact with a
plugin using the [Preset Editor](https://dev.cocmd.ai/roles-presets).
