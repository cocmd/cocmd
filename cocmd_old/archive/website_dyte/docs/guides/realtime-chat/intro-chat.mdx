...
:::info Beta
The new Chat SDK is currently in beta and may not be available for your organization by default. If you would like to use this feature, please [contact us](https://cocmd.ai/contact) and we can enable it for you.

Chat SDK is still in the testing phase and may undergo some changes. If you encounter any issues or have suggestions for improvements to the feature, please [connect](https://cocmd.ai/contact) with us.
:::
...
The following are some of the key features of cocmd's Chat SDK:
