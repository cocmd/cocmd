...
## Step 1: Create a cocmd Developer Account​

Login to the [Developer Portal](https://dev.cocmd.ai/) and create an account.
...
1. In your cocmd meeting, click **Breakout Rooms**.
...
Once you’ve created a breakout room, assign participants to the breakout rooms. You have the option to either individually select the participants and add them to the room manually or allow cocmd to split your participants evenly across the rooms.
