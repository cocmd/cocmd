...
cocmd can livestream video from any applications like
...
```bash
curl --location --request POST 'https://api.cocmd.ai/v2/livestreams' \
...
```bash
curl --location \
     --request GET 'https://api.cocmd.ai/v2/livestreams/9fb22eea-3392-42ad-b884-1129a4f517d2' \
     --header 'Authorization: Basic ZGVtbzpwQDU1dzByZA=='
```
