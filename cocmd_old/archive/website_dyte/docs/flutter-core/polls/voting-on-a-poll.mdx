...
| ----------- | --------------- | ------------- | -------- | ---------------------------------------------------------- |
| pollMessage | cocmdPollMessage | -             | yes      | Contains all the poll properties (question, options, etc.) |
| pollOption  | cocmdPollOption  | yes           | yes      | Option on which the user voted                             |
