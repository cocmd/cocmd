<!-- PROJECT LOGO -->
<p align="center">
  <a href="https://cocmd.ai">
    <img src="https://assets.cocmd.ai/logo-outlined.png" alt="Logo" width="120">
  </a>

  <h2 align="center">cocmd Docs</h3>

  <p align="center">
    cocmd's documentation portal, built with Docusaurus.
    <br />
    <a href="https://docs.cocmd.ai"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://app.cocmd.ai">View Demo</a>
    ·
...
`docs` is created & maintained by cocmd, Inc. You can find us on Twitter - [@dyte_io](https://twitter.com/dyte_io) or write to us at `dev [at] cocmd.ai`.

The names and logos for cocmd are trademarks of cocmd, Inc.

We love open source software! See [our other projects](https://github.com/dyte-in) and [our products](https://cocmd.ai).
