...
[Files]
Source: "{{{executable_path}}}"; DestDir: "{app}"; DestName: "cocmdd.exe"; Flags: ignoreversion
...
[UninstallRun]
Filename: "{cmd}"; Parameters: "/C ""taskkill /im cocmdd.exe /f /t"